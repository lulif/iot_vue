	...
	<div>
		...
		<el-card>
			<el-row :gutter="20">
				...
				<el-col :span="4"><el-button type="primary" @click="showAddDialog">添加设备</el-button></el-col>
			</el-row>

			<el-table :data="goodslist" stripe border style="width: 100%">
				<el-table-column type="index"></el-table-column>
				<el-table-column prop="goods_price" label="设备ID"></el-table-column>
				<el-table-column prop="goods_price" label="设备名称"></el-table-column>
				<el-table-column prop="goods_weight" label="设备型号"></el-table-column>
				<el-table-column prop="goods_weight" label="设备位置"></el-table-column>
		...
		<el-dialog ref="formRef" title="添加设备" :visible.sync="addDialogVisible" @close="addDialogClosed" width="50%">
			<el-form ref="addFormRef" :model="addForm" :rules="addFormRules" label-width="100px">
				<el-form-item label="设备ID：" prop="id"><el-input v-model="addForm.id"></el-input></el-form-item>
				<el-form-item label="设备名称：" prop="deviceName"><el-input v-model="addForm.deviceName"></el-input></el-form-item>
				<el-form-item label="设备型号：" prop="deviceModel"><el-input v-model="addForm.deviceModel"></el-input></el-form-item>
				<el-form-item label="设别位置：" prop="devicePosition"><el-input v-model="addForm.devicePosition"></el-input></el-form-item>
